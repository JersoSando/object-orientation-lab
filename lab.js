...
//Code here
favoriteThings.car = 'Nissan Rogue'
...
let myFirstMotorcycle = new Motorcycle('Yamaha', true, 2, 'silver', 50000);
/*
...
let myFirstBoat = new Boat('SailAway', 'yacht', true, 40, 'white', 2000);
